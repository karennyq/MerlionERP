...
<html>
    <head>
        ...
        <title>Update Monthly Production Plan</title>
        
        <% session.setAttribute("updateMPDList" + request.getParameter("mo_id"), new ArrayList()); %>
        ...
        <script type="text/javascript">
            ...
            function getMODetails(){
                $.ajax({
                    ...
                    data: "action=getMODetails"
                        + "&mo_id=" + $('#mo_id').val()
                        + "&listName=" + "updateMPDList<%= request.getParameter("mo_id")%>",
                    dataType: "json",
                    cache: false,
                    success: function(data){
                        $('#mo_id').val(data.id);
            ...
            function onClickConfirm(){
                $('#updateMPP').panel('expand');
                $.ajax({
                    type: "POST",
                    url: "../ProductionPlanServlet",
                    data: "action=updateMPP"
                        + "&mo_id=" + $('#mo_id').val()
    ...
    <body>
        <div style="padding:3px 2px;border-bottom:1px solid #ccc"><h2>Update Monthly Production Plan</h2></div>  
        <br/>
        ...
        <div id="updateMPP" class="easyui-panel" title="General Details:" style="padding:0px;background:#fafafa;" collapsible="true">
        ...
        <div id="plannedDmd" class="easyui-panel" title="Planned Demand:" style="padding:0px;background:#fafafa;" collapsible="false"> 
            ...
            <div fit="true" style="width:100%;height:250px;">
                <table id="display" class="easyui-datagrid" fit="true"
                       url="../ProductionPlanServlet?action=getPlannedDmdList&listName=updateMPDList<%= request.getParameter("mo_id")%>"
                       toolbar="tb"
