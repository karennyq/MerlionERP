...
<html>
    <head>
        ...
        <title>Sales Inquiry Mgmt (ALL)</title>
        ...
        <script type="text/javascript">      
            ...
            function filterTable(){
                ...
                var f_url='../SalesInquiryServlet?action=loadPage&content=tableALL&inquiry_id='+inquiry_id+'&inquirer_id='+inquirer_id+'&inquiry_priority='+inquiry_priority+'&company_name='+company_name+'&req_date_1='+req_date_1+'&req_date_2='+req_date_2+'';
    ...
    <body>
        <div style="padding:3px 2px;border-bottom:1px solid #ccc">
            <h2>Sales Inquiry Management (ALL)</h2>
        </div> 
        <br/>
        ...
        <div fit="true" style="width:100%; height:500px">
            <table id="tt" class="easyui-datagrid" fit="true" style="width:100%;"  
                   url="../SalesInquiryServlet?action=loadPage&content=tableALL"   
                   toolbar="#tb"  
                   singleSelect="true" fitColumns="true" pagination="true"
                   rownumbers="false">  
                <thead>  
                    <tr> 
                        <th field="pre_sale_doc_id" width="10%" sortable="true">ID</th>  
                        <th field="inquirer" width="20%" formatter="formatInquirerId" sortable="true">Inquirer ID</th>
                        <th field="company_name" width="30%" formatter="formatCompanyName">Company Name</th>
                        <th field="priority" width="20%" sortable="true">Priority</th>
